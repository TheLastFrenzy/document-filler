...
def fill_document(excel_path, service_dir, material_type, template_path, output_path, catalog_path=None):
    ...
    if material_type == "01-数据报表_需求文档":
        ...
        raise ValueError(f"不支持的材料类型: {material_type}。当前支持: 01-API接口开发_需求文档, 02-API接口开发_数据模型设计, 03-API接口开发_接口开发代码, 04-API接口开发_接口测试报告, 05-API接口开发_作业上线记录, 01-库表落地方式_需求文档, 01-数据报表_需求文档, 01-数据统计分析_需求文档, 02-数据报表_设计文档, 02-数据统计分析_设计文档, 03-数据报表_上线记录, 03-数据统计分析_测试文档, 04-数据统计分析_结果表及使用说明")
